...
namespace VGMdb\Component\OAuth;

use VGMdb\Component\OAuth\Security\Http\Firewall\OAuthAuthenticationListener;
use VGMdb\Component\OAuth\Security\Core\Authentication\Provider\OAuthAuthenticationProvider;
